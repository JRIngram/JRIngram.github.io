var blogsList = { 
        blogs: [
        {
            ...
            "content": [
                ...
                '<p>An issue with this was that although in the <code>package.json</code> file it stateed that it is released under a MIT licence, this wasn\'t clear. I added a <code>LICENCE.md</code> file to make this more clear, and hopefully save some people some time. This resolves <a href="https://github.com/leinonen/cucumber-html-report/issues/81">issue #81</a> of this library.</p>',
